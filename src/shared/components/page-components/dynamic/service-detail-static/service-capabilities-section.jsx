...
import { getDefaultServiceCapabilityCard } from './utils'
...
export default function ServiceCapabilitiesSection({ basePath = 'oSCP' }) {
  const {
    register,
    control,
    watch,
  ...
  useEnsureFieldArrayDefault({ fields, append, getValues, name: fieldArrayName, getDefaultValue: getDefaultServiceCapabilityCard })

  return (
    <div className="p-3">
      <Form.Label className="text-uppercase small text-muted mb-3">Service Capabilities</Form.Label>
      ...
      <Form.Label className="text-uppercase small text-muted mb-2">Capability Cards</Form.Label>
          ...
          actions={
            <>
              {index + 1 === fields.length && (
                <Button type="button" onClick={() => append(getDefaultServiceCapabilityCard())} variant="link" size="sm" className="square icon-btn">
        ...
        >
          ...
          <Row>
            <Col md="4" className="add-article">
              <ImageDimensionNote width={100} height={100} subject="capability card logo" />
...
ServiceCapabilitiesSection.propTypes = {
