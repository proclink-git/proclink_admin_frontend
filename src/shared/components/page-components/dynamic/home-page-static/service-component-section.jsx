...
import { getDefaultLinkCard } from './utils'
...
export default function ServiceComponentSection({ basePath = 'oHomePage.oSC' }) {
  const {
    register,
    control,
    watch,
  ...
  useEnsureFieldArrayDefault({ fields, append, getValues, name: fieldArrayName, getDefaultValue: getDefaultLinkCard })

  return (
    <div className="p-3">
      <Form.Label className="text-uppercase small text-muted mb-3">Service Component</Form.Label>
      ...
      {fields.map((field, index) => (
          ...
          actions={
            <>
              {index + 1 === fields.length && (
                <Button type="button" onClick={() => append(getDefaultLinkCard())} variant="link" size="sm" className="square icon-btn">
        ...
        >
          ...
          <Row>
            ...
            <ImageDimensionNote width={776} height={800} subject="service component image" />
...
ServiceComponentSection.propTypes = {
